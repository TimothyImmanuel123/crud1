            ...
            <?php
                 ...
                 <tr>
                     ...
                     <td><img src="images/<?php echo $data_buku['foto']; ?>" style="width: 120px;float: left;margin-bottom: 5px;"></td>
                        <td class = "actions">
                            <a href="ubah.php?id_buku=<?=$data_buku['id_buku']?>" class="btn btn-success">Ubah</a> |
                            <a href="hapus.php?id_buku=<?=$data_buku['id_buku']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger" float="right">Hapus</a>
                        </td>
                 </tr>
                    <?php
                }
